...
Note: 
-Main class not found is often solve by configuring the pom source file
-The default jar file generated by Inttelij often very long, set a default jar file name through POM.XML see the sample
-Make sure the docker hub credential match the docker file hub credential and also Jenkins gloable credential. 
-Make sure that you have commited all the changes to github
