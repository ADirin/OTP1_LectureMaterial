...
2. <ins>**Agile Methodology An iterative approach that focuses on continuous improvement and customer feedback.**<ins>: [Read the Guide](../Week 1/Agile_Scrum.md)
3. <ins>**Scrum An agile framework that uses time-boxed iterations called sprints.**<ins>: [Read the Guide](Week 1/Agile_Scrum.md)
