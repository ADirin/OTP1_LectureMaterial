...
2. [**Review Meetings**](https://github.com/ADirin/OTP1_LectureMaterial/blob/main/Project_Scrum/Scrum_Agile/Sprint_Review_CheckList.md)  
...
- Group presentation on given topics (25 minutes)
  - [Select Presentation Topic](https://github.com/ADirin/OTP1_LectureMaterial/blob/main/Lecture_Presentation/Topics.md)   

## Deadlines  
- **All deadlines are strict.**
- **NOTE:** *Failure to submit the in-class assignment will result in a penalty and may lead to failing the course*
...
- **Activities:**
    ...
    - [Project topic selection](https://github.com/ADirin/OTP1_LectureMaterial/blob/main/Project_Scrum/Project%20Topic/Project-Instructions-Topics.md)
...
| 2.syys  |        | *Sprint2*   | **Review 1** | Maven               | Online                                                |
| 8.syys  |        |             |              | Junit/Coverage      | In-class / update Github                              |
| 16.syys |        | *Sprint3*   | **Review 2** | Jenkins             | Online                                                |
| 22.syys |        |             |              | Jenkins             | In-class                                              |
| 30.syys |        | *Sprint4*   | **Review 3** | Dockers             | online                                                |
| 6.loka  |        |             |              | Dockers             | In-class                                              |
|         |        |             |              |                     | Presentation / qizes / Github Readme                  |
| 20.loka |        |             | **Review 4** |                     | online                                                |
